...
namespace YiSha.Admin.Web.Areas.SystemManage.Controllers
{
    ...
    public class AutoJobController : BaseController
    {
        ...
        {
            var obj = await _autoJobBLL.GetList(param);
            return Json(obj);
        }
        ...
        {
            var obj = await _autoJobBLL.GetPageList(param, pagination);
            return Json(obj);
        }
        ...
        {
            var obj = await _autoJobBLL.GetEntity(id);
            return Json(obj);
        }
        ...
        {
            var obj = await _autoJobBLL.SaveForm(entity);
            return Json(obj);
        }
        ...
        {
            var obj = await _autoJobBLL.DeleteForm(ids);
            return Json(obj);
        }
        ...
        {
            var obj = await _autoJobBLL.ChangeJobStatus(entity);
            return Json(obj);
        }
