...
namespace YiSha.Util.Common
{
    /// <summary>
    /// 验证码表达式
    /// 验证码 System.Drawing 库（Win平台首选此库）
    ///
    /// <para>添加包</para>
    /// <para><b>CentOS</b> 系统：</para>
    /// <para>rpm -ivh https://dl.fedoraproject.org/pub/epel/epel-release-latest-7.noarch.rpm</para>
    /// <para>yum install libgdiplus-devel</para>
    /// <para>ls /usr/lib/libdl*</para>
    /// <para>ln -s libdl-2.xxx.so libdl.so</para>
    /// <para>ln -s /usr/lib/libgdiplus.so /usr/lib/gdiplus.dll</para>
    /// <para><b>Ubuntu</b> 系统：</para>
    /// <para>apt-get install libgdiplus</para>
    /// </summary>
